...
const GOLD_TITLE = "#F4C40A";
const GOLD_HOME_BORDER = "#FFD700";
const HEADER_SUBTEXT = "#B4ACC7";
...
const s = StyleSheet.create({
  ...
  sheet: { backgroundColor: LIGHT_BODY, borderTopLeftRadius: 24, borderTopRightRadius: 24, paddingHorizontal: 20, paddingTop: 18, height: "92%", borderTopWidth: 1, borderColor: "rgba(255,215,0,0.55)", overflow: "hidden" },
  header: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginBottom: 14, paddingBottom: 12, borderBottomWidth: 1, borderBottomColor: "rgba(255,215,0,0.5)", backgroundColor: LIGHT_NAVY, marginHorizontal: -20, marginTop: -18, paddingTop: 16, paddingHorizontal: 16, borderTopLeftRadius: 24, borderTopRightRadius: 24 },
  headerBack: { color: GOLD_TITLE, fontSize: 14, fontWeight: "700" },
  headerTitle: { color: GOLD_TITLE, fontSize: 17, fontWeight: "800" },
  headerDone: { color: GOLD_TITLE, fontSize: 15, fontWeight: "800" },
...
const recStyles = StyleSheet.create({
  ...
  sheet: { backgroundColor: LIGHT_BODY, borderRadius: 22, padding: 24, width: "100%", maxWidth: 360, alignItems: "center", borderWidth: 1, borderColor: "rgba(255,215,0,0.55)" },
  ...
  primaryBtn: { backgroundColor: LIGHT_NAVY, borderRadius: 14, paddingVertical: 14, paddingHorizontal: 32, alignItems: "center", minWidth: 220, borderWidth: 2, borderColor: GOLD_HOME_BORDER },
